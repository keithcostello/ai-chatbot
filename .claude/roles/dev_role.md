...
CONTEXT:
  ...
  references:
    ...
    bundles:
      - ".claude/roles/G3_ACTIVE_REASONING.aipl"
      - ".claude/roles/L3_5_task_response.aipl"
      - ".claude/roles/L4_7_sprint_checklist.aipl"
...
CONTEXT_PROTOCOL:
  location: ".claude/sprints/ai-chatbot/sprint-[X.Y.Z]/CONTEXT.md"
...
WORKFLOW:
  ...
  phases:
    ...
    - phase: 6
      name: "Documentation"
      dev_action: "Update all 8 required docs in docs/"
...
PATH_RESOLUTION:
  ...
  before_creating_files: |
    ...
    touch steertrue/__init__.py steertrue/tests/__init__.py tests/__init__.py
  ...
  evidence_examples:
    correct:
      ...
      - "Tests at tests/page.test.ts - 7/7 passing"
      - "ISSUES.md at .claude/sprints/sprint-6.0/ISSUES.md"
    wrong:
      - "Created add.py"
      - "Tests at page.test.ts"
      - "ISSUES.md created"
...
CHECKPOINT_FORMAT:
  template: |
    ...
    |------|------|--------|-------|
    | [name] | app/ or db/ or lib/ | Created | [X-Y] |
    ...
    ### Test Results
    - Tests run: `npm test tests/[name].test.ts -v`
    - Result: [X/X passing]
    - Output:
    ```
...
FINAL_CHECKPOINT:
  template: |
    ...
    |-------------|------|--------|
    | Source code | app/ or db/ or lib/ | ✅ Complete |
    | Tests | tests/[name].test.ts | ✅ Complete |
    ...
    | UAT.md | .claude/sprints/[sprint-id]/UAT.md | ✅ Created |
    | ISSUES.md | .claude/sprints/[sprint-id]/ISSUES.md | ✅ Final |
    | C4.md | docs/C4.md | ✅ Updated / ⭐️ No changes |
    | API_REFERENCE.md | docs/API_REFERENCE.md | ✅ Updated / ⭐️ No changes |
    | DATA_MODELS.md | docs/DATA_MODELS.md | ✅ Updated / ⭐️ No changes |
    | SEQUENCE_DIAGRAMS.md | docs/SEQUENCE_DIAGRAMS.md | ✅ Updated / ⭐️ No changes |
