 ...
 *
 * Contains:
 * - Google Sign In button (working from Tier 0)
 * - Email/Password form using signIn('credentials')
 * - Error handling for invalid credentials
 *
 * Auth.js Pattern (per OAUTH_BEST_PRACTICES.md):
 * - Use signIn('google') for OAuth
 * - Use signIn('credentials', { email, password, redirect: false }) for email/password
 * - DO NOT create custom /api/auth/login endpoint
 */
